...
from nn_util import get_dropout_mask
from initializers import block_orthogonal
...
class LstmCellWithProjection(torch.nn.Module):
    ...
    """
    def __init__(self, input_size, hidden_size, cell_size, go_forward=True, recurrent_dropout_probability=0.0,
                 memory_cell_clip_value=None, state_projection_clip_value=None):
