...
from nn_util import remove_sentence_boundaries, add_sentence_boundary_token_ids
from elmo_indexer import ELMoCharacterMapper
...
class Elmo(torch.nn.Module):
    ...
    """
    def __init__(self, options_file, weight_file, num_output_representations, requires_grad=False,
